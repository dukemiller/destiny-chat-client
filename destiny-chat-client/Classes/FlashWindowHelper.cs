...
{
    // http://stackoverflow.com/questions/8924556/force-window-to-blink-when-a-particular-event-occurs-in-c-sharp-wpf
    public class FlashWindowHelper
    {
        ...
        public void StopFlashing()
        {
            ...
            if (Win2000OrLater)
            {
                var fi = CreateFlashInfoStruct(_mainWindowHWnd, FLASHW_STOP, uint.MaxValue, 0);
        ...
        public static bool Flash(IntPtr hwnd)
        {
            ...
            if (Win2000OrLater)
            {
                var flashwinfo = CreateFlashInfoStruct(hwnd, FLASHW_ALL | FLASHW_TIMERNOFG, uint.MaxValue, 0);
        ...
        public static bool Flash(IntPtr hwnd, uint count)
        {
            if (Win2000OrLater)
            {
                var flashwinfo = CreateFlashInfoStruct(hwnd, FLASHW_ALL | FLASHW_TIMERNOFG, count, 0);
                return FlashWindowEx(ref flashwinfo);
            }
